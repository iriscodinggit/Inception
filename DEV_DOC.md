...
**git clone https://github.com/iriscodinggit/Inception.git**
**cd inception**

4. Create environment variables

Create a .env file in the srcs/ directory, edit it and fill in the required values.

5. Prepare persistent data directories

Create the directories used for bind mounts:
...
Build containers from a Docker Compose file:

**build yaml docker-compose file: docker compose -f /home/iris/inception/srcs/docker-compose.yml up -d --build**
